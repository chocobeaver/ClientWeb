...
async function renderBookmarks() {
    ...
    let Categories = await API_GetCategory(bookmarks);
    ...
    if (bookmarks !== null) {
        bookmarks.forEach(bookmark => {
            if(selectedCategory==""){$("#content").append(renderBookmark(bookmark));}
        ...
        $(".bookmarkContainer").on("click", function(){
            saveContentScrollPosition();
            window.location.href =$(this).attr("BookmarkURL");
        });
    } else {
    ...
    $("#content").append(`
        <form class="form" id="bookmarkForm">
            ...
            <input 
                ...
                required
                RequireMessage="Veuillez entrer la Category" 
...
function renderBookmark(bookmark) {
    return $(`
     <div class="bookmarkRow" bookmark_id=${bookmark.Id}" >
        <div class="bookmarkContainer noselect" BookmarkURL="${bookmark.Url}">
            <div class="bookmarkLayout">
                <img src="${bookmark.Url}/favicon.ico" class="favicon">
